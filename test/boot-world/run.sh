...
sleep 5
docker cp $container_id:/var/lib/dsta/cluster/shard/worldgenoverride.lua $aux || exit 1
...
sleep 5
docker cp $container_id:/var/lib/dsta/cluster/shard/worldgenoverride.lua $aux 2> /dev/null && exit 1
docker rm -fv $container_id > /dev/null
